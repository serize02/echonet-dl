...
func insertPrediction(db *sql.DB, metaID, modelID int, req models.PredictionRequest) error {
	...
	INSERT INTO predictions (
		meta_id, model_id, predicted_ef, volume_ratio, length_ratio, dice_overlap_std, dice_overlap_ratio, predicted_bias
	) VALUES (?, ?, ?, ?, ?, ?, ?, ?)
	...
	`, metaID, modelID, req.PredictedEF, req.VolumeRatio, req.LengthRatio, req.DiceOverlapStd, req.DiceOverlapRatio, req.PredictedBias)
